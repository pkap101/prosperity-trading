"""Round 3 trader version 43.

Same structure as `trader_v42`, but increases the passive far-strike quote size.

Architecture goal:
- Lean into the backtester-friendly 0/1 wide-strike regime more aggressively.
- This is intentionally tactical and may be mildly overfit if the regime remains stable.
...
VOUCHER_CFG.update({"VEV_6000": {"wide_quote_size": 15}, "VEV_6500": {"wide_quote_size": 15}})

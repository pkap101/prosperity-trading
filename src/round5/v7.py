"""
Round 5 v28 — bump target_pos magnitudes for more aggressive trend exposure.
...
v28: ±8 (80% of pos_limit). 60% more inventory at target.
...
MR_CAP = 6          # max |mr_adj| in position units (don't flip base direction)
...
CFG: dict[str, dict] = {
    ...
    "TRANSLATOR_ECLIPSE_CHARCOAL": {"size": 6, "min_half": 2, "inv_skew": 4, "target_pos": +8},
    # v11: target_pos=+5 (was 0). D5 mid drift +352 ticks; ride the uptrend.
    "TRANSLATOR_ASTRO_BLACK":      {"size": 6, "min_half": 2, "inv_skew": 4, "target_pos": +8},
    # v10: target_pos=-5 (was 0). D5 mid dropped 524 ticks; ride the trend.
    "ROBOT_LAUNDRY":               {"size": 6, "min_half": 2, "inv_skew": 4, "target_pos": -8},
    ...
    "PANEL_1X2":                   {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": -8},
    "UV_VISOR_AMBER":              {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": -8},
    "PEBBLES_M":                   {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},
    "SLEEP_POD_SUEDE":             {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +8},
    "MICROCHIP_RECTANGLE":         {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},
    "GALAXY_SOUNDS_SOLAR_FLAMES":  {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +8},
    "TRANSLATOR_GRAPHITE_MIST":    {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": +8},
    ...
    "PANEL_4X4":                   {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": +8},
    "PEBBLES_XL":                  {"size": 4, "min_half": 4, "inv_skew": 15, "target_pos": +8},
    "GALAXY_SOUNDS_DARK_MATTER":   {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},
    "PANEL_2X2":                   {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": -8},
    "ROBOT_IRONING":               {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +8},
    # v9: target_pos=+5 (REVERSE the losing direction — ride the uptrend).
    "ROBOT_VACUUMING":             {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": +8},
    ...
    "UV_VISOR_RED":                  {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": +8},
    "UV_VISOR_ORANGE":               {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": +8},
    ...
    "GALAXY_SOUNDS_PLANETARY_RINGS": {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},
    # v16: tier-1 upgrade. Drift -398 was under-captured at tier-2 sizing.
    "PANEL_1X4":                     {"size": 4, "min_half": 2, "inv_skew": 15, "target_pos": -8},
    ...
    "SLEEP_POD_COTTON":              {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +8},
    "PEBBLES_S":                     {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},
    "MICROCHIP_OVAL":                {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},

    # ----- v13 ADDITIONS — 4 more trending non-CFG products -----
    "UV_VISOR_MAGENTA":              {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},
    "PANEL_2X4":                     {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},
    "ROBOT_MOPPING":                 {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},
    "MICROCHIP_TRIANGLE":            {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +8},

    # ----- v14 ADDITIONS — 6 more trending non-CFG products -----
    "TRANSLATOR_SPACE_GRAY":         {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},
    "SLEEP_POD_LAMB_WOOL":           {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},
    "MICROCHIP_SQUARE":              {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},
    "OXYGEN_SHAKE_GARLIC":           {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +8},
    "OXYGEN_SHAKE_MINT":             {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},
    "OXYGEN_SHAKE_MORNING_BREATH":   {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},

    # ----- v15 ADDITIONS — small-drift sweep -----
    "PEBBLES_XS":                    {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},
    "TRANSLATOR_VOID_BLUE":          {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +8},
    "SLEEP_POD_NYLON":               {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +8},
    "MICROCHIP_CIRCLE":              {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},

    # ----- v17 ADDITIONS — final low-drift sweep -----
    "SNACKPACK_CHOCOLATE":           {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +8},
    "OXYGEN_SHAKE_EVENING_BREATH":   {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},
    "SLEEP_POD_POLYESTER":           {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": +8},
    "GALAXY_SOUNDS_BLACK_HOLES":     {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},

    # ----- v18 ADDITIONS — smallest-drift sweep -----
    "PEBBLES_L":                     {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},
    "SNACKPACK_VANILLA":             {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},
    "GALAXY_SOUNDS_SOLAR_WINDS":     {"size": 4, "min_half": 3, "inv_skew": 15, "target_pos": -8},
}
